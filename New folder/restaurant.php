  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="room.php" class="page-scroll">Rooms</a></li>
...
<div id="call-reservation" class="text-center">
  <div class="container">
    <h2>Give a call on <strong>1-887-654-3210</strong> to order.</h2>
  </div>
</div>
<!-- Contact Section -->
...
<div id="footer">
  <div class="container text-center">
    ...
    <div class="col-md-4">
      <h3>Contact Info</h3>
      <div class="contact-item">
        <p>Phone: +91 28369220934</p>
        <p>Email: DBMS@spit.ac.in</p>
      </div>
    </div>
  </div>
  <div class="container-fluid text-center copyrights">
    <div class="col-md-8 col-md-offset-2">
      ...
      <p>2023<a href="http://www.templatewire.com" rel="nofollow"></a></p>
    </div>
  </div>
</div>
